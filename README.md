...
<figure>
  <img src= "https://raw.githubusercontent.com/2KAbhishek/mdx-blog/main/images/screenshot.jpg" alt="mdx-blog Demo" style="width:100%">
  <br/>
...
mdx-blog was inspired by `<reason/idea>`.

## What it does

mdx-blog is a `<utility/tool/feature>` that allows `<insert_target_audience>` to do `<action/task_it_does>`.
...
mdx-blog was built using `<tech/library>`

## Challenges faced

While building mdx-blog the main challenges were `<issue/difficulty>`

## What I learned

While building mdx-blog I `<learned/accomplished>` about `<learning/accomplishment>`
